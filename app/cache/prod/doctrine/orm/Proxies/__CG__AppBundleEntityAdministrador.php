...
class Administrador extends \AppBundle\Entity\Administrador implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Administrador' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Administrador' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Administrador' . "\0" . 'password', '' . "\0" . 'AppBundle\\Entity\\Administrador' . "\0" . 'salt', '' . "\0" . 'AppBundle\\Entity\\Administrador' . "\0" . 'nombres', '' . "\0" . 'AppBundle\\Entity\\Administrador' . "\0" . 'apellidos', '' . "\0" . 'AppBundle\\Entity\\Administrador' . "\0" . 'fecha_creacion');
        }
