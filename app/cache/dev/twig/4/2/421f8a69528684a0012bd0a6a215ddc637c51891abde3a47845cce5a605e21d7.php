...
class __TwigTemplate_8c87fc829ddd0a61f1f485391b8397c5f8734402c9130a13e66c6cff3c1a15a0 extends Twig_Template
{
    ...
    {
        $__internal_ce84143ca1169486c66aaf409ccf4d7ecf0a843943ab712bae0e7404db205356 = $this->env->getExtension("native_profiler");
        $__internal_ce84143ca1169486c66aaf409ccf4d7ecf0a843943ab712bae0e7404db205356->enter($__internal_ce84143ca1169486c66aaf409ccf4d7ecf0a843943ab712bae0e7404db205356_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "default/cartelera.html.twig"));
...
\t\t\t\t<a href=\"javascript:mostrarTrailer(1)\"><img width=\"30%\" src=\"";
        // line 12
        echo twig_escape_filter($this->env, $this->env->getExtension('asset')->getAssetUrl("bundles/app/uploads/cartelera/Usted-no-sabe-quien-soy-Yo.jpg"), "html", null, true);
...
\t\t\t\t\t  <source src=\"";
        // line 17
        echo twig_escape_filter($this->env, $this->env->getExtension('asset')->getAssetUrl("bundles/app/uploads/cartelera/videos/Usted-no-sabe-quien-soy-Yo.mp4"), "html", null, true);
        echo "\" type=\"video/mp4\">
\t\t\t\t\t</video>
\t\t\t\t</div>

\t\t\t\t<div id=\"texto1\">¿Usted no sabe quién soy yo? es la divertida historia de Ricardo, (Ricardo Quevedo), un comediante amateur que se intenta dar a conocer haciendo Stand Up Comedy en varios bares de Bogotá. Ricardo está atravesando el más espantoso de los guayabos porque su novia de muchos años lo abandonó por un hombre mayor perteneciente a la farándula colombiana que además tiene mucho dinero. Con sus dos amigos Crist (Freddy Beltrán) y Valentino (Iván Marín) concluyen que en la sociedad colombiana es imposible surgir sin tener plata o ser familiar de una persona importante por lo que es mejor aparentar ser alguien de mejor estrato social e ir diciendo a donde quiera que vayas “¿Usted no sabe quién soy yo?”.
\t\t\t\t</div>
\t\t\t
...
\t";
        ...
        $__internal_ce84143ca1169486c66aaf409ccf4d7ecf0a843943ab712bae0e7404db205356->leave($__internal_ce84143ca1169486c66aaf409ccf4d7ecf0a843943ab712bae0e7404db205356_prof);
    ...
    {
        return array (  139 => 83,  131 => 78,  117 => 67,  109 => 62,  94 => 50,  86 => 45,  72 => 34,  64 => 29,  49 => 17,  41 => 12,  31 => 5,  25 => 2,  22 => 1,);
    }
}
/* */
...
/* 		<div class="cartelera-col2">*/
/* 			<div class="cartelera-texto flip1" style="height: 35vw;">*/
/* 				<a href="javascript:mostrarTrailer(1)"><img width="30%" src="{{ asset('bundles/app/uploads/cartelera/Usted-no-sabe-quien-soy-Yo.jpg') }}" style="height: 30vw; float:left; margin: 3vw;" /></a>*/
/* 				<br><br><div class="t4">¿USTED NO SABE QUIÉN SOY YO?</div><br><br>*/
/* */
/* 				<div id="trailer1" style="display:none;">*/
/* 					<video style="width: 38vw; height: 25vw;" controls>*/
/* 					  <source src="{{ asset('bundles/app/uploads/cartelera/videos/Usted-no-sabe-quien-soy-Yo.mp4') }}" type="video/mp4">*/
/* 					</video>*/
/* 				</div>*/
/* */
/* 				<div id="texto1">¿Usted no sabe quién soy yo? es la divertida historia de Ricardo, (Ricardo Quevedo), un comediante amateur que se intenta dar a conocer haciendo Stand Up Comedy en varios bares de Bogotá. Ricardo está atravesando el más espantoso de los guayabos porque su novia de muchos años lo abandonó por un hombre mayor perteneciente a la farándula colombiana que además tiene mucho dinero. Con sus dos amigos Crist (Freddy Beltrán) y Valentino (Iván Marín) concluyen que en la sociedad colombiana es imposible surgir sin tener plata o ser familiar de una persona importante por lo que es mejor aparentar ser alguien de mejor estrato social e ir diciendo a donde quiera que vayas “¿Usted no sabe quién soy yo?”.*/
